  ...
  window.fetch(
    ...
    .then(function (resJson) {
      ...
      for (var i = 0; i < releases.length; i++) {
        var tempRecord = window.document.createElement('a-entity');
        tempRecord.setAttribute('record-component', 'cover: ' + releases[i].image);
        // tempRecord.setAttribute('position', '3 1 0')
        window.AFRAME.scenes[0].appendChild(tempRecord);
      }
    })
}
